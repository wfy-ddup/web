var currentPage = {
  ...
  pageOperate:{
    ...
    delOrCheck:function(){
      var _this = this;
      $(".table_01").delegate(".del_btn_01","click",function(){
        $(this).parents("tr").remove();
        _this.countTotal();
      });

      $(".table_01").delegate(".check_btn","click",function(){
      ...
      $(".table_01 .all_check").click(function(){
        ...
        $(this).parents(".table_01").find(".check_btn").addClass("checked");
        _this.countTotal();
      });

      $(".table_01").delegate(".btn_no_product","click",function(){
    ...
    changeNum:function(){
      var _this = this;
      $(".table_01").delegate(".reduce_btn","click",function(){
  ...
  init:function(){
    ...
    $(".btn_1").click(function(){
      ...
      if( _this.onceLoadNum >= _this.countData.length ){ return false }
